...
SELECT 
  ...
  TO_CHAR("LUAS_CEA_HEKTAR", '999,999,999.999') AS "LUAS_CEA_HEKTAR"  -- Format angka dengan pemisah ribuan dan 3 desimal
FROM 
  LuasKawasan
...
SELECT 
  ...
  TO_CHAR(SUM("LUAS_CEA_HEKTAR"), '999,999,999.999') AS "LUAS_CEA_HEKTAR"  -- Format total luas dengan pemisah ribuan dan 3 desimal
FROM 
  LuasKawasan
