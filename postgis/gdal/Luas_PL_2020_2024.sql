WITH pl2020_luas AS (
  SELECT
    pl."pl2020_id" AS "PL_ID",
    SUM(
      ST_Area(
        ST_Transform(pl.geom, 54034)
      )
    )::numeric / 10000 AS "LUAS_PL2020_HA"
  FROM datagis."PL2020_AR_250K" pl
  GROUP BY pl."pl2020_id"
),
...
gabungan AS (
  SELECT
    ...
    p23."LUAS_PL2023_HA",
    p24."LUAS_PL2024_HA"
  FROM pl2020_luas p20
  FULL OUTER JOIN pl2021_luas p21
    ON p20."PL_ID" = p21."PL_ID"
  FULL OUTER JOIN pl2022_luas p22
    ON COALESCE(p20."PL_ID", p21."PL_ID") = p22."PL_ID"
  FULL OUTER JOIN pl2023_luas p23
    ON COALESCE(p20."PL_ID", p21."PL_ID", p22."PL_ID") = p23."PL_ID"
  FULL OUTER JOIN pl2024_luas p24
    ON COALESCE(p20."PL_ID", p21."PL_ID", p22."PL_ID", p23."PL_ID") = p24."PL_ID"

  LEFT JOIN kodefikasi."KODE_PL" k20 ON p20."PL_ID" = k20."KD_PL"
...
SELECT
  ...
  NULL AS "PL_ID",
  SUM("LUAS_PL2020_HA") AS "LUAS_PL2020_HA",
