...
cp -fv /tmp/apache-tomcat-9.0.78/bin/*.jar /home/arcgis/portal/framework/runtime/tomcat/bin/
cp -fv /tmp/apache-tomcat-9.0.78/lib/*.jar /home/arcgis/portal/framework/runtime/tomcat/lib/
/home/arcgis/portal/framework/runtime/tomcat/bin/version.sh
